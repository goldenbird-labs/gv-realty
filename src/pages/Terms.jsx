    ...
    <div className="min-h-screen bg-white pt-20">
      <div className="bg-navy-900 py-16 px-6 lg:px-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-4xl text-white mt-3">Terms of Service</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-10 py-16">
        <div className="space-y-8 text-gray-600 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>You may use this website for lawful purposes only. You agree not to use the site to transmit harmful, unlawful, or misleading content, or to interfere with the operation of the website.</p>
          </section>
          <section>
          ...
          <section>
            <h2 className="font-display text-2xl text-navy-900 mb-3">8. Contact</h2>
            <p>Questions about these Terms? Email us at <a href="mailto:hello@gvrealty.com" className="text-gold hover:underline">hello@gvrealty.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
