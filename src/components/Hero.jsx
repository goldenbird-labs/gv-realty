...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative w-full flex flex-col items-center px-6 pt-24 pb-20">
        {/* Big centered logo */}
        <motion.div {...fadeUp(0.1)} className="mb-6 bg-white/80 backdrop-blur-sm rounded-2xl px-10 py-5 shadow-xl">
          <img
            src={gvLogo}
            alt="G&V Realty"
        ...
        {/* Tagline */}
        <motion.p {...fadeUp(0.25)} className="text-white/60 text-base tracking-widest uppercase mb-10">
        ...
        <motion.div
          {...fadeUp(0.4)}
          className="w-full max-w-2xl bg-white/10 backdrop-blur-md border border-white/20"
        >
          {/* Tabs */}
